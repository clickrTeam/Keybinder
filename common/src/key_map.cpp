...
QList<QPair<QString, int>> KeyMap::create_list()
{
    return {
        ...
        {"Escape", VK_ESCAPE}, {"Tab", VK_TAB}, {"Shift", VK_SHIFT},
        {"Ctrl", VK_CONTROL}, {"Alt", VK_MENU}, {"Backspace", VK_BACK},
...
QList<QPair<QString, int>> KeyMap::create_list()
{
    return {
        ...
        // TODO: Add symbols, function keys, arrows, modifiers, etc.
    };
}
...
QList<QPair<QString, int>> KeyMap::create_list()
{
    return {
        ...
        {"Escape", KEY_ESC}, {"Tab", KEY_TAB}, {"Shift", KEY_LEFTSHIFT},
        {"Ctrl", KEY_LEFTCTRL}, {"Alt", KEY_LEFTALT}, {"Backspace", KEY_BACKSPACE},
        ...
        {"Cmd", KEY_LEFTMETA}, {"Super", KEY_LEFTMETA}, {"Meta", KEY_LEFTMETA},
        {"Menu", KEY_MENU}
    };
}
#else
