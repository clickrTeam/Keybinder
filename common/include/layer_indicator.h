...
/**
 * @brief The LayerIndicator class is a QWidget that will pop up when a user
 * switches layers. The purpose of this is to briefly tell the user what layer
 * they are on, so that they can orient themselves.
 */
