#ifdef __linux__
#ifndef LINUX_CONFIGURE_H
#define LINUX_CONFIGURE_H
#include <QString>

///
/// \brief Determines whether a user has a eventX device configured as their keyboard in the config file
...
///
/// \brief Determines whether a user has a eventX device configured as their keyboard in the config file.
/// This uses the default file path
/// \return QString eventX if an eventX device is found, empty string otherwise
///
