 ...
 * I am not sure why they were coming across twice in the first place. I think
 * it has something to do with "transliation units" Mark remaps as extern so
 * that it can be used in the .cpp file. NOTE: May not be necessary.
 */
